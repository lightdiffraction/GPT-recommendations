...
class QueryProcessor():
    ...
    def process(self):
        if (self.query.artist is not None) and (self.query.genre is not None):
        ...
        elif (self.query.artist is None) and (self.query.genre is not None):
        ...
        elif (self.query.artist is not None) and (self.query.genre is None):
        ...
        elif (self.query.artist is None) and (self.query.genre is None):
